    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card card-primary card-outline">
                <div class="card-header"><h3 class="card-title">Thêm mục vào menu</h3></div>
                <div class="card-body">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // FIX: Handle focus when modal is closed to prevent accessibility issues.
            ...
            menuContainer.addEventListener('click', function (e) {
                ...
                if (editButton) {
                    e.preventDefault();
                    triggerButton = editButton; // Store the button that opened the modal
