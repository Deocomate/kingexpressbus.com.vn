<?php
// MẸO DEBUG: Để debug lỗi trong queue, anh có thể tạm thời thêm dòng này vào đầu file.
// Nó sẽ dừng queue worker và in ra toàn bộ dữ liệu mà view này nhận được trong console.
// Sau khi debug xong hãy xóa nó đi.
// dd($bookingDetails);
?>
<!DOCTYPE html>
<html lang="vi">
        ...
        <tr>
            <td align="center">
                <table width="600" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 10px 0;">
                            <p style="margin: 10px 0; font-size: 14px;"><strong style="font-weight: bold;">Kính gửi Quý
                                    khách {{ $bookingDetails['customer_name'] ?? 'N/A' }},</strong><br>
                                <span style="font-style: italic; color: #555555;">Dear Mr/Ms
                                    {{ $bookingDetails['customer_name'] ?? 'N/A' }},</span>
                            </p>
                            <p style="margin: 10px 0; font-size: 14px;">
                                King Express Bus xin chân thành cảm ơn Quý khách đã tin tưởng và sử dụng dịch vụ của
                                chúng
                                tôi. Chúng tôi xác nhận thông tin yêu cầu đặt vé của Quý khách như sau:<br>
                                <span style="font-style: italic; color: #555555;">King Express Bus would like to thank
                                    you for trusting and using our services. We confirm your booking request information
                                    as follows:</span>
                            </p>
                            <h3
                                style="color: #B8860B; border-bottom: 1px solid #eeeeee; padding-bottom: 5px; margin-top: 25px; margin-bottom: 15px; font-size: 16px;">
                            ...
                            <table width="100%" border="0" cellpadding="10" cellspacing="0"
                                ...
                                <tbody>
                                    <tr>
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; background-color: #f9f9f9; width: 150px; font-weight: bold; color: #555555;">
                                            Mã đặt vé (ID)
                                        </th>
                                        <td
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; font-weight: bold; color: #333333;">
                                            #{{ $bookingDetails['booking_code'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr style="background-color:#f9f9f9">
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; width: 150px; font-weight: bold; color: #555555;">
                                            Họ tên (Name)
                                        </th>
                                        <td style="border: 1px solid #dddddd; padding: 10px; text-align: left;">
                                            {{ $bookingDetails['customer_name'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; width: 150px; font-weight: bold; color: #555555;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #dddddd; padding: 10px; text-align: left;">
                                            {{ $bookingDetails['start_province'] ?? 'N/A' }}
                                    ...
                                    <tr style="background-color:#f9f9f9">
                                        ...
                                        <td
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; font-weight: bold; color: #333333;">
                                            {{ $bookingDetails['departure_date'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; width: 150px; font-weight: bold; color: #555555;">
                                        ...
                                        <td
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; font-weight: bold; color: #333333;">
                                            {{ $bookingDetails['start_time'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr style="background-color:#f9f9f9">
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; width: 150px; font-weight: bold; color: #555555;">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; font-weight: bold; color: #333333;">
                                            {{ $bookingDetails['quantity'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr style="background-color:#f9f9f9">
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; width: 150px; font-weight: bold; color: #555555;">
                                        ...
                                        <td style="border: 1px solid #dddddd; padding: 10px; text-align: left;">
                                            {{ $bookingDetails['pickup_info'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th
                                            style="border: 1px solid #dddddd; padding: 10px; text-align: left; width: 150px; font-weight: bold; color: #555555;">
                                    ...
                                    <tr style="background-color:#f9f9f9">
                                        ...
                                        <td style="border: 1px solid #dddddd; padding: 10px; text-align: left;">
                                            @if ($bookingDetails['payment_method'] === 'cash_on_pickup')
                                                Thanh toán khi lên xe / <span
                                                    style="font-style: italic; color: #555555;">Pay on board</span>
                                            @elseif($bookingDetails['payment_method'] === 'online_banking')
                                                ...
                                                @else
                                                    Chuyển khoản ngân hàng (Chờ xác nhận) / <span
                                                        style="font-style: italic; color: #555555;">Bank Transfer
                            ...
                            @if ($bookingDetails['needs_bank_transfer_info'] && $bookingDetails['payment_status'] !== 'paid')
                                ...
                                <p style="font-size: 14px; margin-bottom: 15px;">
                                    Khi đặt các dịch vụ tại King Express Bus, để giữ và đảm bảo dịch vụ quý khách vui
                                    lòng
                                    thanh toán cho booking. Việc thanh toán thông thường được tiến hành bằng các cách
                                    sau:
                                </p>
                                <p style="font-size: 14px; margin-bottom: 10px; padding-left: 15px;">
                                    <strong>1 – Thanh toán tiền mặt:</strong> Quý khách đến và thanh toán trực tiếp tại
                                    công
                                ...
                                <p style="font-size: 14px; margin-bottom: 10px; padding-left: 15px;">
                                    <strong>2 – Chuyển khoản qua ngân hàng:</strong> Quý khách chuyển khoản cho chúng
                                    tôi
                                    theo thông tin tài khoản mà chúng tôi cung cấp dưới đây. Khi chuyển khoản quý khách
                                    lưu
                                ...
                                <table width="100%" border="0" cellpadding="8" cellspacing="0"
                                    ...
                                    <tr style="background-color:#f9f9f9;">
                                        <td
                                            style="border: 1px solid #dddddd; padding: 8px; font-weight: bold; color: #555555; width: 170px;">
                                            Ngân hàng (Bank):
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="border: 1px solid #dddddd; padding: 8px; font-weight: bold; color: #555555;">
                                            Số tài khoản (Account No.):
                                        </td>
                                        <td
                                            style="border: 1px solid #dddddd; padding: 8px; font-weight: bold; color: #B8860B;">
                                            2924300366
                                        </td>
                                    </tr>
                                    <tr style="background-color:#f9f9f9;">
                                ...
                                <p style="font-size: 13px; color: #777777; margin-bottom: 5px; padding-left: 15px;">
                                    <i>Lưu ý: Quý khách vui lòng chỉ chuyển khoản vào các số tài khoản trên. Trong
                                        trường
                                        hợp quý khách chuyển khoản ngoài các số trên nếu có rủi ro nào khác, công ty
                                        không
                                        chịu trách nhiệm.</i>
                                </p>
                            @endif
                            ...
                            <p style="margin-top: 20px; font-size: 14px;">Cảm ơn Quý khách đã lựa chọn King Express
                                Bus!</p>
                    ...
                    <tr>
                        <td
                            style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #eeeeee; font-size: 12px; color: #777777; text-align: center;">
                            <p style="margin: 5px 0;">
                                © {{ date('Y') }} {{ $bookingDetails['web_title'] ?? 'King Express Bus' }}. All
                                rights
                                reserved.</p>
